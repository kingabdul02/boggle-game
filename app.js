...
function tick()
{
 ...
 {
  timeremaining = 0;
  score = document.getElementById('total-score').innerHTML;
  alert('Your time is off and your total score is: '+score+' points. Press (Ok) to play again.');
  location.reload();
 } else
 {
